...
<template>
    <section>
        <header>
            <h2 class="text-lg font-medium text-gray-900">Información de su Perfil</h2>

            <p class="mt-1 text-sm text-gray-600">
                Actualiza tu información de perfil y tu cuenta de correo.
            </p>
        </header>
        ...
        <form @submit.prevent="form.patch(route('profile.update'))" class="mt-6 space-y-6">
            ...
            <div v-if="mustVerifyEmail && user.email_verified_at === null">
                <p class="text-sm mt-2 text-gray-800">
                    Cuenta de correo sin verificar.
                    <Link
                    ...
                    >
                        Click para enviar nuevamente el email.
                    </Link>
                </p>
                ...
                >
                    Se ha enviado un varificación de correo a la cuenta proporcionada.
                </div>
            </div>
