  ...
  <transition
    ...
    <aside v-show="$page.props.showingMobileMenu" class="fixed inset-y-0 z-20 flex-shrink-0 w-64 mt-16 overflow-y-auto rojo-morena md:hidden">
      <div class="py-4 text-white">
        ...
        <li class="relative px-6 py-3">
            <ResponsiveNavLink :href="route('refugios')" :active="route().current('refugios')">
                <template #icon>
            ...
            <li class="relative px-6 py-3">
                <ResponsiveNavLink :href="route('colonias-dt')" :active="route().current('colonias-dt')">
                    <template #icon>
            ...
            <li class="relative px-6 py-3">
                <ResponsiveNavLink :href="route('asigar-colonias-a-refugios-index')" :active="route().current('asigar-colonias-a-refugios-index')">
                    <template #icon>
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-6">
